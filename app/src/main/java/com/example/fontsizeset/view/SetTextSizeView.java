...
public class SetTextSizeView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        defaultCircleRadius = dp2px(context, 30);
        ...
        mCirclePaint.setShadowLayer(3, 0, 0, Color.rgb(200, 200, 200));
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // 实体圆
        canvas.drawCircle(circleX, circleY, circleRadius-1, mCirclePaint);
    }
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (canMove) {
                    ...
                    Point targetPoint = getNearestPoint(moveX);
                    if (targetPoint != null) {
                        invalidate();
                    }
                }
